...
namespace Cme
{
    ...
    public:
        // ctor/dtor
        Cylinder(float FuckbaseRadius = 1.0f, float FucktopRadius = 1.0f, float Fuckheight = 1.0f,
            int FucksectorCount = 36, int FuckstackCount = 1, bool Fucksmooth = true, int Fuckup = 3);
        ~Cylinder();
